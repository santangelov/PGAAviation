...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Portfolio Banner -->
    <header class="portfolio1-banner">
           <div class="container">
               <div class="row">
                   <div class="col-md-12">
                       <h2 class="main-text">aircraft-based <span class="part"> transactions</span></h2>
                          <div class="intro-text">PGA leadership</div>
                   </div>
               </div>    
           </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="row margin-top">
            ...
            <a href="#"><img class="img-hover" src="img/737NGa.jpg" alt="Boeing 737NG aircraft"/></a>
              ...
              Mid-life 737NG Acquisition</div>
                <p class="portfolio-two-columns-text">PGA served as sole advisor to major investor in its acquisition of eleven (11) airplanes.</p>
            </div>
			<!-- END TRANSACTION -->
            ...
            <a href="#"><img class="img-hover" src="img/CFM56-7B.jpg" alt="CFM56-7B aircraft engine"/></a>
              ...
              CFM56-7B engines</div>
                <p class="portfolio-two-columns-text">PGA served as sole originator of transaction in which a western lessor procured multiple CFM56-7B engines.</p>
            </div>
			<!-- END TRANSACTION -->
           ...
           <div class="col-md-6 img-portfolio"> <a href="#"><img class="img-hover" src="img/MD-11.jpg" alt="McDonnell Douglas MD-11 aircraft"/></a>
              ...
              MD-11F fleet phase-out</div>
                <p class="portfolio-two-columns-text">PGA served as lead originator for a major network carrier's MD-11F fleet phase-out project</p>
            </div>
			<!-- END TRANSACTION -->
           ...
           <div class="col-md-6 img-portfolio">
                ...
                <div class="portfolio-header-two-columns">
                  Historic 777-300ER
              Deal</div>
                <p class="portfolio-two-columns-text">PGA team members sealed the historic sale of 15 777-300ER aircrafts to a major Chinese airline in 2007, valued at over $3 billion, during their tenures with the OEM</p>
          </div>
			<!-- END TRANSACTION -->
            ...
            <div class="col-md-6 img-portfolio">
                ...
                <p class="portfolio-two-columns-text">The team at PGA was a lead player in selling hundreds of new Mainliners into the China market</p>
            </div>
			<!-- END TRANSACTION -->
           ...
           <div class="col-md-6 img-portfolio">
                ...
                <div class="portfolio-header-two-columns">
                    Procurement</div>
                <p class="portfolio-two-columns-text">PGA served as lead originator for a bank-owned leasing company's new airplane procurement project</p>
            </div>
			<!-- END TRANSACTION -->
           ...
           <div class="col-md-6 img-portfolio">
            ...
            <div class="col-md-6 img-portfolio">
                ...
                <p class="portfolio-two-columns-text">PGA served as advisor to leading part-out company in its acquisition of 4 737-700 airplanes</p>
            </div>
			<!-- END TRANSACTION -->
            ...
            <div class="col-md-6 img-portfolio">
                ...
                <p class="portfolio-two-columns-text">Team members at PGA sold regional jets and turboprops to Chinese airlines</p>
            </div>
			<!-- END TRANSACTION -->
 
 			<!-- START TRANSACTION -->
            <div class="col-md-6 img-portfolio">
                <a href="img/Airbus A319.jpg">
                   <img class="img-hover" src="img/Airbus A319.jpg" alt="Airbus A319"/>
                </a>
                <div class="portfolio-header-two-columns">
                  Mid-life A319 Sale and Lease Novation Transaction
              </div>
                <p class="portfolio-two-columns-text">PGA served as sole arranger and advisor to an US-based lessor in a transaction involving the sale and lease novation of 2 mid-life A319.</p>
            </div>
			<!-- END TRANSACTION -->
        ...
        <!--<div class="row text-center">
            <div class="col-md-12 pagination1">
                <ul class="pagination">
                    <li>
                        <a href="#">&laquo;</a>
                    </li>
