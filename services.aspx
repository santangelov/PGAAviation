...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header class="services-banner">
           <div class="container">
               <div class="row">
                   <div class="col-md-12">
                       <h2 class="main-text">Servi<span class="part">ces</span></h2>
                          <div class="intro-text">aircraft remarketing</div>
                   </div>
               </div>    
           </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="row margin-top">
           ...
           <div class="col-md-4">
              <h4>About us</h4>
              <p>PGA's business model and business lines are evolving.  In the Appraisal Service, Consulting Service, Technical Service and Asset Management areas, PGA works with its partner company, Morten Beyer &amp; Agnew, in the Greater China market.</p>
              <p>PGA's roster of <a href="team.aspx">professionals</a> possess an aggregate of many years of experience within the largest US and Canada airframe manufacturers, as well as many years of legal experience with large law firms in New York.  Such experience includes transactions with large and small airlines in China and around the world, including many national flag carriers.</p>
           </div>
           <div class="col-md-4">
               <div class="media">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Commercial Aircraft Re-Marketing</h4>
                   </div>
               </div>
               <div class="media" style="margin-top:2em;">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Mid-life and End-of-life Commercial Aircraft disposal/phaseout solutions</h4>
                   </div>
               </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Business Jet long-term charter arrangements and resale solutions</h4>
                   </div>
               </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">P2F conversions cost management</h4>
                   </div>
              </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Aircraft procurement consulting services</h4>
                   </div>
              </div>
           </div>
           <div class="col-md-4">
               <div class="media">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">China General Aviation Initiatives</h4>
                   </div>
               </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Cross-Border Aviation Joint-Venture Initiatives</h4>
                   </div>
               </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Aircraft Sales and Leaseback arrangements</h4>
                   </div>
              </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">Engines Sales and Leaseback arrangements</h4>
                   </div>
              </div>
               <div class="media" style="margin-top:2em;">
                   <div class="pull-left">
                   ...
                   <div class="media-body">
                       <h4 class="media-heading">PRC Aviation Policy Advisory Services</h4>
                   </div>
              </div>
           </div>
