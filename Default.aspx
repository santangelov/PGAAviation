...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h2 class="page-header">
                    New York City Based Operations
              </h2>
                   <div class="hr"></div>
            </div>
            <div class="col-md-6 col-md-offset-3">
                <p class="sub-text"><span class="red">PGA as an aircraft remarketing firm has positioned itself as a creative niche player in the marketplace.  Our team has a very strong background in the China Aviation market. Chinese airlines and leasing companies come to us as an important bridge to the western community.</span></p>
            </div>
    ...
    <div class="testimonials-banner">
        <div class="container">
            <div class="col-md-12">
                <h1 class="main-text">Deal Originator in New York <span class="part">and China</span>
                </h1>
            </div>
        </div>
     </div>
